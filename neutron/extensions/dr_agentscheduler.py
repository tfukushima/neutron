...
class Dr_agentscheduler(extensions.ExtensionDescriptor):
    ...
    def get_resources(cls):
        ...
        controller = resource.Resource(RoutingPeerSchedulerController(),
                                       base.FAULT_MAP)
...
class RoutingPeerSchedulerPluginBase(service_base.ServicePluginBase):
    ...
    @abc.abstractmethod
    def list_dr_agents_hosting_peer(context, routingpeer_id):
        pass
