...
class RoutingPeerNotHosted(exceptions.NotFound):
...
class AgentAssociatedRoutingInstance(exceptions.Conflict):
    message = _("The agent %(agent_id)s is already associated to a routing "
                "instance.")
...
class Dr_agentscheduler(extensions.ExtensionDescriptor):
    ...
    @classmethod
    def get_alias(cls):
        return "dynamic_routing_agent_scheduler"
...
class DynamicRoutingSchedulerPluginBase(service_base.ServicePluginBase):
    ...
    def get_plugin_name(self):
        return constants.DR_AGENT_SCHEDULER
