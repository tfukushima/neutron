...
def upgrade(active_plugins=None, options=None):
    ...
    op.create_table(
        ...
        sa.Column('configuration', sa.String(length=4096), nullable=False),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.CheckConstraint('ipv4 != NULL or ipv6 != NULL', name='ipv4_or_ipv6')
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['routinginstance_id'],
                                ['routinginstances.id'],
                                ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('destination', 'routinginstance_id')
    )
